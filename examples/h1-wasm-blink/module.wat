;; Tessera A4c proof-of-life module. Matches what the DSL compiler
;; emits for:
;;
;;   import Core.LED.heartbeat(period_ms: int)
;;   loop { Core.LED.heartbeat(500) }
;;
;; tessera_start runs once at boot (empty here); tessera_loop is
...
(module
  ...
  (func (export "tessera_start"))
  (func (export "tessera_loop")

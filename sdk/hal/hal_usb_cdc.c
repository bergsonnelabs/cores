 ...
 *
 * Self-contained USB Device core + CDC-ACM class for STM32L422.
 * Handles enumeration, control transfers, and bulk data entirely
 * in the USB interrupt handler.
 *
 * All USB EP and common register access uses 16-bit (volatile uint16_t *)
 * as required by the STM32L4 USB FS peripheral.
 */

/**
 * ble_timer.c -- BLE Timer module (from ST working project)
 *
 * Manages BLE stack timers using UTIL_TIMER (stm32_timer.c) and AMM
 * for dynamic allocation of timer objects.
 */
